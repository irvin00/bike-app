...
```bash
curl -s http://127.0.0.1:8000/api/bikes | python3 -m json.tool
```
...
```bash
# Active only
curl -s "http://127.0.0.1:8000/api/bikes?status=active" | python3 -m json.tool

# Former only
curl -s "http://127.0.0.1:8000/api/bikes?status=former" | python3 -m json.tool
```
...
```bash
curl -s http://127.0.0.1:8000/api/bikes/1 | python3 -m json.tool
```
